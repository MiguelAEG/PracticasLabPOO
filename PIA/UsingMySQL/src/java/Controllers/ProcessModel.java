 ...
 * @author A
 */
public class ProcessModel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            usr.setFname(request.getParameter("fnameadd"));
            usr.setLname(request.getParameter("lnameadd"));
            ...
            String sql = "INSERT INTO user (fname, lname) VALUES ('" + usr.getFname() + "', '" + usr.getLname()
                    + "')";
